    	...
    	else
    	{
	    	...
	    	if(isset($buyInfo['goods']['id']) && $buyInfo['goods']['id'])
	    	{
	    		...
	    		foreach($goodsList as $key => $val)
	    		{
	    			...
	    			$groupPrice                = ($val['goods_id'] == 946) ? $buyInfo['goods']['dprice'] : $this->getGroupPrice($val['goods_id'],'goods');
	    	...
	    	if(isset($buyInfo['product']['id']) && $buyInfo['product']['id'])
	    	{
	    		...
	    		foreach($productList as $key => $val)
	    		{
	    			...
	    			$groupPrice                = ($val['goods_id'] == 946) ? $buyInfo['goods']['dprice'] : $this->getGroupPrice($val['product_id'],'product');
