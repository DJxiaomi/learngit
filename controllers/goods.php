...
class Goods extends IController implements adminAuthorization
{
	...
	function goods_list()
	{
		...
		$goodsHandle->fields   = "distinct go.id,go.name,go.sell_price,go.market_price,go.store_nums,go.img,go.is_del,go.seller_id,go.is_share,go.sort,s.shortname as s_shortname";
	 ...
	 * 上传课堂相册图片
	 */
	function goods_upload_class_pics()
	{
