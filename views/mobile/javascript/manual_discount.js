...
function pullupRefresh() {
    setTimeout(function() {
        ...
        mui.get(SITE_URL + 'site/get_manual_discount_list_ajax', params, function(json){
            if(json.num < 10){
            ...
            for (var i = 0; i < json.num; i++) {
                ...
                li.innerHTML = '<a href="' + url + '"><div class="mui-card" id="' + seller_id + '">' +
                                 ...
                                 '<div class="mui-card-content">' +
																		...
																		'<div class="t-right">' +
																	 		'<div class="goods-name">' + json[i].name + '</div>' +
																			'<div class="goods-addr">' + json[i].address + '</div>' +
																			'<div class="goods-content">' + json[i].seller_name + '</div>' +
																		'</div>' +
																 '</div>' +
                               '</div></a>';
