...
<div class="main f_r">
    <div class="new-box">
        <div class="nt"><i class="icon-share-alt"></i>我的转让<span><a href="<?php echo IUrl::creatUrl("/ucenter/order_transfer");?>" class="blue">发布转让</a></span></div>

        <div class="menu">
          <ul>
            <li class="active"><a href="<?php echo IUrl::creatUrl("/ucenter/order_transfer_list");?>"><i class="icon-user"></i>我的转让</a></li>
            <li><a href="<?php echo IUrl::creatUrl("/ucenter/buytransfer");?>"><i class="icon-user"></i>我的转让订单</a></li>
          </ul>
        </div>
        <table class="new-table">
            ...
            <tr>
                <td>
                    ...
                    <a href="<?php echo IUrl::creatUrl("/site/products/id/".$item['goods_id']."");?>" class="blue" target="_blank"><?php echo isset($item['goods_name'])?$item['goods_name']:"";?></a>
                    <?php }else{?>
                    <?php echo isset($item['transfername'])?$item['transfername']:"";?>
                    <?php }?>
                </td>
                <td><a href="<?php echo IUrl::creatUrl("/site/seller/id/".$item['seller_id']."");?>" class="blue" target="_blank"><?php echo isset($item['true_name'])?$item['true_name']:"";?></a></td>
                <td>￥<?php echo isset($item['transprice'])?$item['transprice']:"";?></td>
                <td><?php echo isset($item['addtime'])?$item['addtime']:"";?></td>
                <td>￥<?php echo isset($item['commission'])?$item['commission']:"";?></td>
                <!-- <td><b class="orange"><?php echo isset($item['paytype'])?$item['paytype']:"";?></b></td>
                <td><b class="orange"><?php if($item['ispay'] == 1){?>已支付<?php }else{?>未支付<br /><a href="<?php echo IUrl::creatUrl("/block/tdoPay/order_id/".$item['id']."");?>" class="blue">去支付</a><?php }?></b></td> -->
                <td><b class="orange"><?php if($item['state'] == 1){?>转让成功<?php }else{?>转让中<?php }?></b></td>
                <td><?php if($item['state'] == 1){?>已完成，不能编辑<?php }else{?><a class="blue" href="<?php echo IUrl::creatUrl("/ucenter/order_transfer_edit/id/".$item['id']."");?>">编辑<?php }?></a>
                </td>
            </tr>
            <?php }?>
            <tfoot><tr><td colspan="9" class="t_l"><?php echo isset($page_info)?$page_info:"";?></td></tr></tfoot>
        </table>
    </div>
</div>
