...
<script language="javascript">
  var _del_url = "<?php echo IUrl::creatUrl("/ucenter/article_del/id");?>";
</script>

<div class="main f_r">
    <div class="main f_r">
        <div class="new-box">
            <div class="nt"><i class="icon-file"></i>我的文章<span><a href="<?php echo IUrl::creatUrl("/ucenter/article_add");?>" class="blue">发布文章</a></span></div>
            <table class="new-table">
                ...
                <?php if($article_list){?>
                  ...
                  <tr>
                      <td></td>
                      <td><a href="<?php echo IUrl::creatUrl("/site/article_detail/id/".$item['id']."");?>" class="orange" target="_blank"><?php echo isset($item['title'])?$item['title']:"";?></a></td>
                      <td><?php echo isset($item['create_time'])?$item['create_time']:"";?></td>
                      <td><?php echo isset($item['views'])?$item['views']:"";?></td>
                      <td><?php echo isset($item['reply_count'])?$item['reply_count']:"";?></td>
                      <td>
                        <a href="<?php echo IUrl::creatUrl("/ucenter/article_add/id/".$item['id']."");?>" title="修改"><img class="operator" src="/views/sysdefault/skin/default/images/admin/icon_edit.gif" alt="修改"></a>
                  ...
                  <?php }?>
                  <tfoot><tr><td colspan="6" class="t_l"><?php echo isset($page_info)?$page_info:"";?></td></tr></tfoot>
                <?php }else{?>
                <tr>
                  <td colspan="6">
                    暂时没有任何文章
...
<script type='text/javascript' src="<?php echo $this->getWebViewPath()."javascript/ucenter_article_list.js";?>"></script>
