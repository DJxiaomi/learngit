...
<body class="index">
	...
	<div class="<?php if( ($this->getId() == 'site' && $_GET['action'] == 'index') || ($this->getId() == 'site' && $_GET['action'] == '') || ($this->getId() == 'site' && $_GET['action'] == 'intro')){?>module_content_index<?php }else{?>module_content<?php }?>">
		<link href="<?php echo $this->getWebSkinPath()."css/ucenter_promote.css";?>" rel="stylesheet" type="text/css" />
<div class="main f_r">
    <div class="new-box">
        <div class="nt"><i class="icon-group"></i>我的推广</div>
        <div class="">
          <table border="0" class="new-table2">
            <tr>
              <td class="promo_code">我的推广码：<b><?php echo isset($my_promote_code)?$my_promote_code:"";?></b><a href="http://www.dsanke.com/plugins/phpqrcode/index.php?data=http://www.dsanke.com/site/index/promote/<?php echo isset($my_promote_code)?$my_promote_code:"";?>" target="_blank">我的推广二维码</a></td>
            </tr>
          </table>
            <table class="new-table info">
                <tr>
                  <th>我的推广</th>
                  <th>个人用户</th>
                  <th>个人返佣</th>
                ...
                <tr>
                  <td><a href="<?php echo IUrl::creatUrl("/ucenter/promote_previous_month");?>">上月推广</a></td>
        ...
        <div class="hd">
          <ul>
            <li <?php if($type == '1'){?>class="active"<?php }?>><a href="<?php echo IUrl::creatUrl("/ucenter/promote/type/1");?>">最新推广</a></li>
            <li <?php if($type == '2'){?>class="active"<?php }?>><a href="<?php echo IUrl::creatUrl("/ucenter/promote/type/2");?>">最新成交</a></li>
            <li <?php if($type == '3'){?>class="active"<?php }?>><a href="<?php echo IUrl::creatUrl("/ucenter/promote/type/3");?>">商家用户</a></li>
            <li <?php if($type == '4'){?>class="active"<?php }?>><a href="<?php echo IUrl::creatUrl("/ucenter/promote/type/4");?>">个人用户</a></li>
          </ul>
        </div>
