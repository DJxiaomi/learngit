...
<div class="wrapper clearfix">
	...
	<form action='<?php echo IUrl::creatUrl("/simple/cart3d");?>' method='post' name='order_form' onsubmit='return orderFormInstance.isSubmit()'>
				...
				<div class="wrap_box">
					...
					<table width="100%" class="border_table m_10">
						...
						<tbody>
							...
							<tr>
								<th><label><input type="radio" name="delivery_id" value="<?php echo isset($item['id'])?$item['id']:"";?>" paytype="<?php echo isset($item['type'])?$item['type']:"";?>" <?php if(!$key){?>checked<?php }?> onclick='orderFormInstance.deliverySelected(<?php echo isset($item['id'])?$item['id']:"";?>);' /><?php echo isset($item['name'])?$item['name']:"";?></label></th>
								<td>
