...
<?php $goodsObj = search_goods::find(array('category_extend' => $this->childId),25);$resultData = $goodsObj->find()?>


<link href="<?php echo $this->getWebSkinPath()."css/pro_list.css";?>" rel="stylesheet" type="text/css" />
<div class="position">
	<span>您当前的位置：</span>
	...
	<div class="main f_r" >
		...
		<ul class="display_list clearfix m_10">
			...
			<li name="goodsItems" class="clearfix win"  >
				<div class="current">
					<a title="<?php echo isset($item['name'])?$item['name']:"";?>" href="<?php echo IUrl::creatUrl("/site/products/id/".$item['id']."");?>"><img class="lazy" data-original="<?php echo IUrl::creatUrl("/pic/thumb/img/".$item['img']."");?>"  alt="<?php echo isset($item['name'])?$item['name']:"";?>" title="<?php echo isset($item['name'])?$item['name']:"";?>" name="goodsImage"  src="<?php echo $this->getWebSkinPath()."images/dsanke.png";?>"/></a>
				</div>
			    <div class="intro1">
				<p class="intro_title"><a title="<?php echo isset($item['name'])?$item['name']:"";?>" href="<?php echo IUrl::creatUrl("/site/products/id/".$item['id']."");?>"><?php echo isset($item['name'])?$item['name']:"";?></p>
				<p class="intro_key"><?php echo isset($item['keywords'])?$item['keywords']:"";?></p>
