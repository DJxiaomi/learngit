...
<?php $seo_data['title'] = '课程转让'?>
<?php $seo_data['title'].="_".$site_config->name?>

<link href="<?php echo $this->getWebSkinPath()."css/transfer_list.css";?>" rel="stylesheet" type="text/css" />

<div class="position">
	<span>您当前的位置：</span>
	<a href="<?php echo IUrl::creatUrl("");?>">首页</a> >> 课程转让
</div>
...
<div class="wrapper clearfix container_2">
		...
		<ul class="clearfix">
			...
			<?php foreach($transfer_list as $key => $item){?>

			<li class="clearfix">

				<div class="pic">

					<a title="<?php if($item['transfername']){?><?php echo isset($item['transfername'])?$item['transfername']:"";?><?php }else{?>转让-<?php echo isset($item['goods']['name'])?$item['goods']['name']:"";?><?php }?>" href="<?php echo IUrl::creatUrl("/site/transfer_show/id/".$item['id']."");?>" target="_blank">
						<img src="<?php if($item['transferpic']){?><?php echo IUrl::creatUrl("/pic/thumb/img/".$item['transferpic']."/w/283/h/283");?><?php }else{?><?php echo IUrl::creatUrl("/pic/thumb/img/".$item['goods']['img']."/w/283/h/283");?><?php }?>" width="283" height="283" />
					</a>

				</div>

				<h3 class="title">
						<a title="<?php if($item['transfername']){?><?php echo isset($item['transfername'])?$item['transfername']:"";?><?php }else{?>转让-<?php echo isset($item['goods']['name'])?$item['goods']['name']:"";?><?php }?>" class="blue" href="<?php echo IUrl::creatUrl("/site/transfer_show/id/".$item['id']."");?>" target="_blank"><?php if($item['transfername']){?><?php echo isset($item['transfername'])?$item['transfername']:"";?><?php }else{?>转让-<?php echo isset($item['goods']['name'])?$item['goods']['name']:"";?><?php }?></a>
				</h3>
				<p>转让人：<?php echo isset($item['username'])?$item['username']:"";?></p>
				<p>总课时：<?php echo isset($item['totaltime'])?$item['totaltime']:"";?></p>
				<p>剩余课时：<?php echo isset($item['minustime'])?$item['minustime']:"";?></p>
				<?php if($item['istalk']){?>
				<p>已与商家沟通好</p>
				<?php }?>
				<div class="brief"><?php echo isset($item['content'])?$item['content']:"";?></div>
				<div class="price"><em>￥</em><b style=" text-decoration: line-through;"><?php if($item['sellerprice']){?><?php echo isset($item['sellerprice'])?$item['sellerprice']:"";?><?php }else{?><?php echo isset($item['goods']['sell_price'])?$item['goods']['sell_price']:"";?><?php }?></b></div>
					<div class="price"><em>￥</em><b><?php echo isset($item['transprice'])?$item['transprice']:"";?></b></div>
				<div class="handle clearfix">
				<a title="转让-<?php echo isset($item['goods']['name'])?$item['goods']['name']:"";?>" href="<?php echo IUrl::creatUrl("/site/transfer_show/id/".$item['id']."");?>" target="_blank">查看详细</a>
				</div>
			</li>
		...
		<p class="display_list mt_10" style='margin-top:50px;margin-bottom:50px'>
			<strong class="gray f14">对不起，没有找到相关信息</strong>
		</p>
		<?php }?>
		<!--课程列表展示-->
