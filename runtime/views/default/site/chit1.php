...
<div class="free_class_content">
  <div class="free_class_hd">
    <img src="<?php echo $this->getWebSkinPath()."images/dqk_img_1.png";?>" />
  </div>
  <div class="free_class_bd">
    ...
    <ul>
      ...
      <li>
      	<a href="<?php echo IUrl::creatUrl("/site/chit1_detail/id/".$item['seller_id']."");?>">
            <div class="class_image">
              <img  class="lazy" data-original="<?php echo IUrl::creatUrl("")."".$item['logo']."";?>" />
            </div>
            <div class="class_action">
              <p class="tt"><?php echo isset($item['seller_name'])?$item['seller_name']:"";?></p>
              <p class="detail">课程：<?php echo isset($item['goods_names'])?$item['goods_names']:"";?></p>
              <p class="price">价格：<em><?php echo isset($item['min_price'])?$item['min_price']:"";?></em>起</p>
            </div>
