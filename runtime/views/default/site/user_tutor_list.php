...
<script type="text/javascript" src="<?php echo $this->getWebViewPath()."/javascript/result.js";?>"></script>
<div class="">
    ...
    <div class="t_list_cont">
      <div class="fl column">
        ...
        <div class="filter-sortbar">
          ...
          <a class="fl <?php if($search['order'] == 'tutor_price'){?>default<?php }?>" href="<?php echo search_goods::searchUrl('order','tutor_price');?>">
            <span>价格</span>
            <i class="icon-sort"></i>
          </a>
        ...
        <div class="filter_list">
          <ul>
            ...
            <a href="<?php echo IUrl::creatUrl("/site/user_tutor_info/id/".$item['id']."");?>" target="_blank">
              <li>
                <table>
                  <tbody>
                  <tr>
                    <td class="head"><img src="<?php echo IUrl::creatUrl("")."".$item['head_ico']."";?>"></td>
                    <td class="user-info">
                      <p><span class="user-name"><?php echo isset($item['true_name'])?$item['true_name']:"";?></span></p>
                      <p><i class="icon-book"></i> 需补课课程：
                        <?php echo category_class::get_category_title($item['grade']);?>
                      </p>
                      <p><i class="icon-book"></i> 需补课年级：
                        <?php echo category_class::get_category_title($item['grade_level']);?>
                      </p>
                      <p>&nbsp;<i class="icon-map-marker"></i>&nbsp;&nbsp;地址：<?php echo area::getName($item['region_id']);?> <?php echo isset($item['address'])?$item['address']:"";?> <?php echo isset($item['address2'])?$item['address2']:"";?></p>
                      <p class="specialty"></p></td>
                    <td class="price-info"><p><strong> ￥<span class="price"><?php echo isset($item['price'])?$item['price']:"";?></span></strong> 元</p></td>
        ...
        <div class="t_list_sbox">
          ...
          <ul>
            ...
            <li>
              ...
              <a href="<?php echo IUrl::creatUrl("/site/tutor_info/id/".$item['id']."");?>" class="t_simg"><img src="<?php echo IUrl::creatUrl("")."".$item['logo']."";?>"></a>
