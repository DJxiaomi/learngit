                ...
                <?php if($item['thumb']){?>
      						<li class="artCon-list">
      							...
      							<div class="artDet fr">
      								...
      								<p class="art-details c6"><?php echo isset($item['summary'])?$item['summary']:"";?></p>
                      <div class="artInfo">
      								  <p class="c9 f12 artDate"><?php echo  date('Y年m月d日 H:i:s', strtotime( $item['create_time']));?></p>
      								   <div class="art-share"><span class="shareit f12 orange"><?php echo isset($item['views'])?$item['views']:"";?></span><span  class="comment f12 orange"><a class="pingjia f12 orange" href="<?php echo IUrl::creatUrl("/site/article_detail/id/".$item['id']."");?>#reply" target="_blank"><?php echo str_replace('\n','<br>',$item['reply_count']);?></a></span></div>
                      </div>
      							</div>
      						</li>
                <?php }else{?>
