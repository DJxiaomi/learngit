...
<link href="<?php echo $this->getWebSkinPath()."css/help.css";?>" rel="stylesheet" type="text/css" />
<script type='text/javascript' src="<?php echo $this->getWebViewPath()."javascript/help.js";?>"></script>
<script language="javascript">
var SITE_URL = '<?php echo get_host();?>';
</script>
...
<div class="container_2 wrapper clearfix">
	...
	<div class="top_content">
		<div class="top_menu">
			<a href="<?php echo IUrl::creatUrl("/site/help_list");?>"><img src="<?php echo $this->getWebSkinPath()."images/help_menu_2.png";?>"></a>
			<a href="tencent://message/?Menu=yes&uin=2821518520&Service=58&SigT=A7F6FEA02730C9881B11E0AE7AF2E2413E3090997F5951E7CFC7F66A8EF4F5D7A3233F568A8EBC2B984019AC21FF99093F241FB5CD7A7DD4C39596B28D63C849FBCF4A5AED55184EFE696F36F9FF6428EEC729D42EF963C0FD5E9BAC2AD18620E7ADFC9387D83C4B46A7B0C2DC4B63341934EE44C822C196"><img src="<?php echo $this->getWebSkinPath()."images/help_menu_1.png";?>"></a>
		</div>

		<div class="search_form" >
			<div class="help_logo"><a href="<?php echo IUrl::creatUrl("/");?>"><img src="<?php echo $this->getWebSkinPath()."images/dsk_help_logo.png";?>" /></a></div>
			<form name="form1" method="GET" action="<?php echo IUrl::creatUrl("/site/help_list");?>">
				<div class="help_search">
		      <input type="text" name="key" placeholder="请输入关键词" /><input type="submit" name="btn" value="搜索">
		    </div>
			</form>
		</div>
	</div>
	...
	<div class="help_content" >
	    ...
	    <div class="hd" >问题分类</div>
		<?php foreach(Api::run('getHelpCategoryLeft',10) as $key => $item){?>
		<div class="hc_title" show_list="1"><i><?php if($item['show']){?>+<?php }else{?>-<?php }?></i><strong><?php echo isset($item['name'])?$item['name']:"";?></strong></div>
		<ul class="list m_10">
...
<script>
	$('.hc_title').hover(function(){
		$(this).addClass('hover');
	}, function(){
		$(this).removeClass('hover');
	});
	$('.help_c ul.list li a').hover(function(){
		$(this).addClass('hover');
	}, function(){
		$(this).removeClass('hover');
	});
