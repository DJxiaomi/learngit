...
<div class="wrapper clearfix container_2">
	<div class="sidebar f_l">
		...
		<div class="box m_10">
			<?php echo Ad::show("商品搜索结果页左侧198*120(default)");?>
		</div>
		<div class="box m_10">
	...
	<?php require(ITag::createRuntime("_goods_list_filter"));?>
		...
		<?php $goodsObj1 = Seller_class::get_seller_info_by_bid($item['brand_id'])?>
			...
			<li name="goodsItems" class="clearfix win"  >
				<div class="current">
					<a title="<?php echo isset($item['name'])?$item['name']:"";?>" href="<?php echo IUrl::creatUrl("/site/products/id/".$item['id']."");?>"><img class="lazy" data-original="<?php echo IUrl::creatUrl("/pic/thumb/img/".$item['img']."");?>"  alt="<?php echo isset($item['name'])?$item['name']:"";?>" src="<?php echo $this->getWebSkinPath()."images/dsanke.png";?>" title="<?php echo isset($item['name'])?$item['name']:"";?>" name="goodsImage" /></a>
				</div>
			    <div class="intro1">
