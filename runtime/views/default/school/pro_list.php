 ...
 <!-- fixed topbar end -->
	...
	<div class="container mt20">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="thumbnail">
					<a href="<?php echo IUrl::creatUrl("/site/products/id/".$item['id']."");?>" target="_blank"><img src="<?php echo IUrl::creatUrl("/".$item['img']."");?>" alt=""></a>
					<div class="caption">
						<h3 class="mb10"><?php echo isset($item['name'])?$item['name']:"";?><span>￥<?php echo isset($item['sell_price'])?$item['sell_price']:"";?></span></h3>
						<div class="options mb10">
							<p> <i><?php echo isset($item['sale'])?$item['sale']:"";?> 报名</i> | <a href="single.html"><?php echo isset($item['comments'])?$item['comments']:"";?> 评价</a></p>
						</div>
						<a href="<?php echo IUrl::creatUrl("/site/products/id/".$item['id']."");?>" class="hvr-shutter-in-horizontal more">购买课程</a>
					</div>
				</div>
			</div>
			<?php }?>
