...
<link rel="stylesheet" href="<?php echo $this->getWebSkinPath()."css/order_verification.css";?>" />
<div class="mui-content-padded">
	<form class="mui-input-group" action="<?php echo IUrl::creatUrl("/seller/order_verification_update");?>" method="post" enctype='multipart/form-data' id="brandFrom">
		<div class="mui-input-row">
			<label>订单验证码</label>
			<input type="text" name="verification_code"  id="verification_code" placeholder="请输入要核销订单的验证号码" />
		</div>

		<div class="mui-button-row">
			<button type="button" class="mui-btn mui-btn-primary" onclick="verification()">确认</button>&nbsp;&nbsp;
		</div>
	</form>
</div>
