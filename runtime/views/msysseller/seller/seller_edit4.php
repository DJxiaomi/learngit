...
<div class="mui-content-padded" style="margin:0;">
	<form class="mui-input-group" action="<?php echo IUrl::creatUrl("/seller/seller_add4");?>" method="post" enctype='multipart/form-data' id="brandFrom">
		<div class="mui-input-row">
			<label>开户银行名称：</label>
			<input type="text" name="account_bank_name" value="<?php echo isset($this->sellerRow['account_bank_name'])?$this->sellerRow['account_bank_name']:"";?>" placeholder="请输入开户银行名称" />
		</div>
		<div class="mui-input-row">
			<label>开户支行：</label>
			<input type="text" name="account_bank_branch" value="<?php echo isset($this->sellerRow['account_bank_branch'])?$this->sellerRow['account_bank_branch']:"";?>" placeholder="请输入开户支行名称" />
		</div>
		<div class="mui-input-row">
			<label>账户姓名：</label>
			<input type="text" name="account_name" value="<?php echo isset($this->sellerRow['account_name'])?$this->sellerRow['account_name']:"";?>" placeholder="开户账户姓名" />
		</div>
		<div class="mui-input-row">
			<label>银行卡号：</label>
			<input type="text" name="account_cart_no" value="<?php echo isset($this->sellerRow['account_cart_no'])?$this->sellerRow['account_cart_no']:"";?>" placeholder="银行卡号" />
		</div>
		<div class="mui-input-row" style="display:none;">
			<label>保证金数额(人民币（元）)：</label>
			<input type="text" name="cash" value="<?php echo isset($this->sellerRow['cash'])?$this->sellerRow['cash']:"";?>" placeholder="" />
		</div>
		<div class="mui-input-row" style="display:none;">
			<label>商品定金比例：</label>
			<input type="text" name="deposit" value="<?php echo isset($this->sellerRow['deposit'])?$this->sellerRow['deposit']:"";?>" placeholder="用于分期付款首付比例设置" />
		</div>
