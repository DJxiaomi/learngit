...
<body>
	...
	<link rel="stylesheet" href="<?php echo $this->getWebSkinPath()."css/order_all_list.css";?>" />
<div class="mui-card">
    <ul class="mui-table-view">
        <li class="mui-table-view-cell">
            <a class="mui-navigate-right" href="<?php echo IUrl::creatUrl("seller/promote");?>">
                推广列表
            </a>
        </li>
        <?php }?>
        <li class="mui-table-view-cell">
            <a class="mui-navigate-right" href="<?php echo IUrl::creatUrl("seller/sale_tixian");?>">
                账户交易额
            </a>
        </li>
        <li class="mui-table-view-cell">
            <a class="mui-navigate-right" href="<?php echo IUrl::creatUrl("seller/tixian_list");?>">
                提现记录
            </a>
        </li>
    </ul>
