...
<div class="headbar">
	...
	<div class="searchbar">
		<form action="<?php echo IUrl::creatUrl("/");?>" method="get" name="prom_order_list">
			...
			<select name="search[promo_code]" class="auto">
				...
				<option value="<?php echo isset($item['key'])?$item['key']:"";?>" <?php if($search['promo_code'] == $item['key']){?>selected<?php }?>><?php echo isset($item)?$item:"";?></option>
				<?php }?>
			</select>
...
<form name="orderForm" id="orderForm" action="<?php echo IUrl::creatUrl("/market/prom_order_list");?>" method="post">
	<div>
		<table class="list_table">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo isset($item['order_goods']['name'])?$item['order_goods']['name']:"";?>-<?php echo isset($item['order_goods']['value'])?$item['order_goods']['value']:"";?></td>
					<td><?php echo isset($item['order_amount'])?$item['order_amount']:"";?></td>
					<td><?php echo isset($item['order_str'])?$item['order_str']:"";?></td>
					<td><?php echo isset($item['create_time'])?$item['create_time']:"";?></td>
					<td><?php echo isset($item['commission_count'])?$item['commission_count']:"";?></td>
				</tr>
				<?php }?>
			</tbody>
		</table>
