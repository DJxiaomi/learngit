...
<div class="headbar">
	<div class="position">营销<span>></span><span>分销推广</span><span>></span><span>推广商户列表</span></div>
	<div class="searchbar">
		<form action="<?php echo IUrl::creatUrl("/");?>" method="get" name="prom_seller_list">
			<input type='hidden' name='controller' value='market' />
			<input type='hidden' name='action' value='prom_seller_list' />
...
<form name="orderForm" id="orderForm" action="<?php echo IUrl::creatUrl("/market/prom_seller_list");?>" method="post">
	<div>
		<table class="list_table">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo isset($item['order_count'])?$item['order_count']:"";?></td>
