...
<body>
	<div class="container">
		...
		<div id="admin_right">
			<div class="headbar">
	<div class="position"><span>营销</span><span>></span><span>代金券管理</span><span>></span><span>代金券组合</span></div>
	<div class="operating">
		<a href="javascript:void(0)" onclick="event_link('<?php echo IUrl::creatUrl("/market/brand_zuhe_edit_step1");?>');"><button class="operating_btn" type="button"><span class="addition">添加组合</span></button></a>	</div>
</div>
<div class="content">
	<form method='post' action='#'>
        ...
        <col width="100px" />
			...
			<tbody>
        <?php if($brand_chit_zuhe_list){?>
          <?php foreach($brand_chit_zuhe_list as $key => $item){?>
          <tr>
			  <td></td>
			  <td><?php echo isset($item['id'])?$item['id']:"";?></td>
			  <td><?php echo isset($item['name'])?$item['name']:"";?></td>
			  <td><?php echo isset($item['price'])?$item['price']:"";?></td>
			  <td><?php if($item['status'] == 1){?>上架<?php }else{?>下架<?php }?></td>
			  <td><a href="<?php echo IUrl::creatUrl("/market/brand_zuhe_edit/id/".$item['id']."");?>">修改</a>&nbsp; &nbsp; <a href="<?php echo IUrl::creatUrl("/market/brand_zuhe_del/id/".$item['id']."");?>">下架</a></td>
          </tr>
          <?php }?>
