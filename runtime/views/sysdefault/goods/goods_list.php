...
<div class="headbar">
	...
	<div class="operating">
		<a href="javascript:void(0);"><button class="operating_btn" type="button" onclick="window.location.href='<?php echo IUrl::creatUrl("/goods/goods_edit_1");?>'"><span class="addition">添加商品</span></button></a>
		...
		<table class="list_table">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo isset($item['s_shortname'])?$item['s_shortname']:"";?></td>
					<td>
					<?php $catName = array()?>
					...
					<td>
						<a href="<?php echo IUrl::creatUrl("/goods/goods_edit_1/id/".$item['id']."");?>"><img class="operator" src="<?php echo $this->getWebSkinPath()."images/admin/icon_edit.gif";?>" alt="编辑课程" /></a>
