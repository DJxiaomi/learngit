...
<div class="headbar">
	...
	<div class="operating">
		<a href="javascript:;"><button class="operating_btn" type="button" onclick="window.location='<?php echo IUrl::creatUrl("/brand/brand_edit");?>'"><span class="addition">添加学校</span></button></a>
		<div class="search f_r">
			<form name="searchbrand" action="<?php echo IUrl::creatUrl("/");?>" method="get">
...
<div class="content">
	<table id="list_table" class="list_table">
		...
		<tbody>
			...
			<?php $query = new IQuery("brand");$query->order = "id desc";$query->where = "$conditon";$query->page = "$page";$items = $query->find(); foreach($items as $key => $item){?>
			<tr>
