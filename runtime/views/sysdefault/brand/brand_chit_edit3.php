...
<div class="content_box">
	<div class="content form_content">
		<form action="<?php echo IUrl::creatUrl("/brand/brand_chit_save3");?>" method="post" enctype='multipart/form-data'>
			<table class="form_table" cellpadding="0" cellspacing="0">
				<col width="150px" />
				<col />
				<tr>
					<th>优惠名称：</th>
					<td><input class="normal" name="name" type="text" value="<?php echo isset($chit2['name'])?$chit2['name']:"";?>" pattern="required" alt="优惠名称不能为空" />
					</td>
				</tr>
				<tr>
					<th>所属学校：</th>
					<td>
						<select class="auto selectpicker show-tick form-control" name="seller_id" data-live-search="true">
							...
							<option value="<?php echo isset($item['id'])?$item['id']:"";?>" <?php if($item['seller_id'] == $item['id']){?>selected<?php }?>><?php echo isset($item['true_name'])?$item['true_name']:"";?>-<?php echo isset($item['seller_name'])?$item['seller_name']:"";?></option>
							<?php }?>
						</select>
					</td>
				</tr>
				...
				<tr>
					<th>优惠详情：</th><td><textarea class="normal" name="content" id="content" type="text" style="width:700px;height:400px;"><?php echo isset($chit2['content'])?$chit2['content']:"";?></textarea></td>
				</tr>
				<tr style="display:none;">
