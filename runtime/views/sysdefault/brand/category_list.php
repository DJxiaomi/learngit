...
<body>
	<div class="container">
		...
		<div id="admin_right">
			<div class="headbar">
	<div class="position"><span>学校</span><span>>></span><span>学校地区</span><span>></span><span>地区列表</span></div>
	<div class="operating">
		<a href="javascript:;"><button class="operating_btn" type="button" onclick="window.location='<?php echo IUrl::creatUrl("/brand/category_edit");?>'"><span class="addition">添加地区</span></button></a>
	</div>
</div>
<div class="content">
