...
<div class="headbar">
	...
	<div class="operating">
		<a href="javascript:void(0)" onclick="event_link('<?php echo IUrl::creatUrl("/system/takeself_edit");?>')"><button class="operating_btn" type="button"><span class="addition">添加地点</span></button></a>
