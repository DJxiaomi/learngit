...
<body>
	...
	<div class="operating">
		...
		<a href="javascript:void(0);" style="display:none;"><button class="operating_btn" type="button" onclick="window.location='<?php echo IUrl::creatUrl("/member/seller_edit");?>'"><span class="addition">添加商户</span></button></a>
		...
		<a href="javascript:void(0);"><button class="operating_btn" type="button" onclick="window.location='<?php echo IUrl::creatUrl("/member/import_seller_list");?>'" title="导出所有商户" alt="导出所有商户"><span class="filter">导出所有商户</span></button></a>
	</div>
</div>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="<?php echo IUrl::creatUrl("/brand/brand_chit/bid/".$item['brand_id']."");?>" style="display:none;">代金券</a>
					</td>
				</tr>
				<?php }?>
			</tbody>
