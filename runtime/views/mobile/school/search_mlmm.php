...
<div class="free_class_content">
  ...
  <div class="free_class_bd">
    <div class="free_class_search">
      <input type="text" name="key" placeholder="请输入选手的名称/编号" value="<?php echo isset($keyword)?$keyword:"";?>"/><input type="button" name="btn" value="搜索">
    </div>
    <?php if($list){?>
...
$(window).scroll(function(){
	...
	if( a + $(window).height() > load_position -10 && _loading == false && _curr_page < _page_count )
	{
		...
		$.get( _ajax_data_url, {page: _curr_page,id:<?php echo isset($seller_id)?$seller_id:"";?>,key:'<?php echo isset($keyword)?$keyword:"";?>'}, function( result ){
