...
<form action='<?php echo IUrl::creatUrl("/simple/cart3d");?>' method='post' name='order_form' id="order_form">
	...
	<input type='hidden' name='goods_type' value='<?php echo isset($goods_type)?$goods_type:"";?>' />
	<input type='hidden' name='goods_id' value='<?php echo isset($goods_id)?$goods_id:"";?>' />
	<input type='hidden' name='goods_sell_price' value='<?php echo isset($goods_sell_price)?$goods_sell_price:"";?>' />
