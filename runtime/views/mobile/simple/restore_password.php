...
document.getElementById('restore').addEventListener('tap', function(){
    ...
    mui.post('<?php echo IUrl::creatUrl("/simple/do_restore_password_ajax");?>', {user_id: '<?php echo isset($user_id)?$user_id:"";?>',password: password, repassword: repassword, hash: '<?php echo isset($hash)?$hash:"";?>', type: '<?php echo isset($type)?$type:"";?>'}, function(json){
        if(json == '1'){
            window.location.href = '<?php echo IUrl::creatUrl("/simple/login");?>' + '?&callback=<?php echo IUrl::creatUrl("/ucenter/index");?>';
        }else{
