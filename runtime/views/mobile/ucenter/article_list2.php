...
<div class="mui-card">
    ...
    <div class="mui-card-footer">
        ...
        <a class="mui-card-link" href="<?php echo IUrl::creatUrl("/ucenter/article_add2/id/".$item['id']."");?>">修改</a>
    </div>
</div>
<?php }?>
<?php }else{?>
...
$(function(){
		mui('body').on('tap', '.mui-add',function(){
			document.location.href = '<?php echo IUrl::creatUrl("/ucenter/article_add2");?>';
		})
