...
<link href="<?php echo $this->getWebSkinPath()."css/ucenter_favorite.css";?>" rel="stylesheet" type="text/css" />

<script language="javascript">
var _del_url = '<?php echo IUrl::creatUrl("/ucenter/favorite_del_ajax");?>';
var isrefesh = false;
</script>

<input type="hidden" id="pagenum" value="1">
<div class="mui-scroll-wrapper list" id="favorite_list">
...
<script type="text/javascript" src="<?php echo $this->getWebViewPath()."javascript/ucenter_favorite.js";?>"></script>
