...
<h5 class="mui-content-padded">修改交易密码</h5>
<form class="mui-input-group" action="<?php echo IUrl::creatUrl("/ucenter/update_trade_password_edit");?>" method="post" enctype='multipart/form-data' id="passwordForm">
	<div class="mui-input-row">
		<label>交易密码</label>
		<input type="password" placeholder="请输入交易密码" value="" name="password" id="password" />
	</div>
	<div class="mui-input-row">
		<label>确认密码</label>
		<input type="password" placeholder="请确认交易密码" value="" name="repassword" id="repassword" />
	</div>
