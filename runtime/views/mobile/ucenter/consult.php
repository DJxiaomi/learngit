...
<ul class="mui-table-view">
	<?php foreach($consult_list as $key => $item){?>
    <li class="mui-table-view-cell mui-media">
        <a href="<?php echo IUrl::creatUrl("/site/products/id/".$item['gid']."");?>">
            ...
            <div class="mui-media-body">
                ...
                <p class="ordbigbt"><?php echo isset($item['question'])?$item['question']:"";?></p>
                <p class="ordbigbt"><?php echo date('Y-m-d', strtotime( $item['time'] ) ); ?></p>
                <?php if($item['answer']){?><p class="ordbigbt"><?php echo isset($item['answer'])?$item['answer']:"";?></p><?php }?>
            </div>
        </a>
    </li>
    <?php }?>
