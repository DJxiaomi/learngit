...
<link rel="stylesheet" href="<?php echo $this->getWebSkinPath()."css/ucenter.css";?>" type="text/css" />
<script src="<?php echo $this->getWebViewPath()."javascript/crop/touch.min.js";?>"></script>
<script src="<?php echo $this->getWebViewPath()."javascript/crop/jquery.crop.js";?>"></script>
...
$(function(){
    ...
    $('.imageBox').crop({
        ...
        callback:function(ret){
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo IUrl::creatUrl("/ucenter/save_icon");?>',
                data: {imgurl: ret},
                dataType: 'json',
                success: function(json){
                    if(json.msg == 1){
                        mui.toast('头像上传成功');
                        setTimeout(function(){window.location.href = '<?php echo IUrl::creatUrl("/ucenter");?>';}, 1000);
                    }else{
                        mui.toast('头像上传失败');
                    }
