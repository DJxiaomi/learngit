...
<ul class="mui-table-view">
        ...
        <img class="mui-media-object mui-pull-left" src="<?php echo IUrl::creatUrl("")."".$dqk_info['logo']."";?>">
        <div class="mui-media-body"><?php echo isset($dqk_info['name'])?$dqk_info['name']:"";?>-<?php echo isset($dqk_info['use_times'])?$dqk_info['use_times']:"";?>课时
          <p class="mui-ellipsis">已使用<?php echo sizeof($use_list);?>次</p>
          <div class="address"><?php echo isset($dqk_info['seller_name'])?$dqk_info['seller_name']:"";?></div>
        </div>
      </li>
</ul>
...
<div class="mui-card order_log">
    <div class="mui-card-content">
        <ul class="mui-table-view">
            <?php foreach($use_list as $key => $item){?>
            <li class="mui-table-view-cell"><span><?php echo date('Y-m-d H:i',$item['time']);?></span>使用1次</li>
            <?php }?>
        </ul>
    </div>
</div>
