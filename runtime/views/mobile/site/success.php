		...
		<div class="czbox">
			<div class="czboxnr">
						...
						<div class="go_action">
							...
							<?php if($callback){?>
							<center>
							<button type="button" class="mui-btn mui-btn-primary mui-btn-block" id="withdraw" href="<?php echo IUrl::creatUrl("".$callback."");?>"
                            style="width: 80%;margin:10px 10px 10px;padding: 10px 15px;border: 1px solid #5cc2d0;background-color: #5cc2d0;"><?php if($callback_str){?><?php echo isset($callback_str)?$callback_str:"";?><?php }else{?>返回<?php }?></button>
							<?php }?>
							<br/>
