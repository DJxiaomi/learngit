...
<script language="javascript">
  ...
  var _article_thumb_url = '<?php echo IUrl::creatUrl("/site/article_thumb_ajax");?>';
...
<div class="mui-content-padded article-content">
	...
	<p>
		<?php if($article_info['user_name']){?><?php echo isset($article_info['user_name'])?$article_info['user_name']:"";?><?php }else{?>第三课<?php }?>
    ...
    <div class="article_action" style="width: 100%;text-align:center;background-color:#fff;padding: 10px 0;">
      <a href="javascript:void(0);" id="<?php echo isset($id)?$id:"";?>"><?php echo isset($article_info['thumb_count'])?$article_info['thumb_count']:"";?></a>
    </div>
	</div>
	<?php if($reply_list){?>
