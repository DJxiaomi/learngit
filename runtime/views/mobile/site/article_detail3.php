...
<div class="mui-content-padded article-content">
	...
	<div class="content">
		<img src="<?php echo IUrl::creatUrl("")."".$article_info['content']."";?>" />
    <div class="action" style="width: 100%;text-align:center;background-color:#fff;padding: 10px 0;">
      <a href="javascript:void(0);" id="<?php echo isset($item['id'])?$item['id']:"";?>"><?php if($item['views'] >0){?>$item['views']<?php }else{?>0<?php }?></a>
    </div>
	<div calss="action" style="width: 100%;text-align:center;background-color:#fff;padding: 10px 0;">
		点击右上角分享给好友，为自己拉票
	</div>
	</div>
	<?php if($reply_list){?>
