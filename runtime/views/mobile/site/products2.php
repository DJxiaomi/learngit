...
<div class="pro-header goodstab">
	...
	<a href="#shop-speak" style="font-weight:600;color:#de4002;">试听报告</a>
</div>
<div class="shop-nav-bot<?php if($seller['is_authentication'] == 1){?><?php if($discount <= 0){?> cxd-1<?php }?><?php }else{?> cxd-2<?php }?>">
		<?php if($seller['is_authentication'] == 1){?>
			...
			<?php }else{?>
				<a<?php if($nextid){?> href="<?php echo IUrl::creatUrl("/site/products/id/".$nextid."");?>"<?php }else{?> href="javascript:;" onclick="alert('没有其他课程')"<?php }?> class="shopbtn">下一门课</a>
				<a href="javascript: void(0);" onclick="joinCart();" class="add-shop" id="joinCarButton">加入课表</a>
				<?php if($discount > 0){?>
				<a href="javascript: void(0);" onclick="buy_now_ding2('<?php echo isset($statement)?$statement:"";?>');" class="ashop" id="joinCarButton" >支付定金</a>
				<?php }?>
...
<div class="mui-content-padded">
	<div class="content">
		...
		<!-- <dl class="clearfix"> -->
			<!-- <dt>开课时间：</dt> -->
			<!-- <dd><span><?php echo isset($up_time)?$up_time:"";?></span></dd> -->
		<!-- </dl> -->
		<!-- <?php }?> -->
		<div class="contee"><p><?php echo isset($content)?$content:"";?></p></div>
	</div>
</div>
...
<div class="mui-content-padded mui-content-padded-last-child" id="shop-speak">
	<h5><a href="<?php echo IUrl::creatUrl("/site/article_discussion/id/".$id."");?>" class="pingjia" style="color:#de4002;font-weight:600;width:100%;height:100%;display:block;">填写试听报告</a></h5>
