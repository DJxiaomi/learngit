...
<div class="mui-content">
  <form class="mui-input-group" method="POST">
    ...
    <div class="mui-input-row">
        <label>课程名称</label>
        <div class="seller_name"><?php echo isset($brand_chit_info['name'])?$brand_chit_info['name']:"";?> - <?php echo isset($brand_chit_info['use_times'])?$brand_chit_info['use_times']:"";?>课时</div>
    </div>
    <div class="mui-input-row">
        <label>交易密码</label>
    ...
    <input type="hidden" name="use_id" value="<?php echo isset($use_id)?$use_id:"";?>" />
</form>
</div>
