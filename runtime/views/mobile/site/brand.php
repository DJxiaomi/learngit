...
<input type="hidden" id="cat" value="<?php echo isset($cat_info['id'])?$cat_info['id']:"";?>">
...
<div class="pro-tab">
	<a href="javascript:;" id="category"><?php echo isset($cat_info['name'])?$cat_info['name']:"";?></a>
        ...
        mui.get(SITE_URL + 'site/get_brand_list_ajax', params, function(json){
            ...
            for (var i = 0; i < json.num; i++) {
                ...
                li.className = 'mui-table-view-cell mui-media';
                	li.innerHTML = '<a href="<?php echo IUrl::creatUrl("/site/brand_zone");?>/id/' + json[i].id + '">'+
