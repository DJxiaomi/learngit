...
<link rel="stylesheet" href="<?php echo $this->getWebSkinPath()."css/chit1.css";?>" rel="stylesheet" type="text/css" />
<link rel="stylesheet" href="<?php echo $this->getWebSkinPath()."css/manual_discount.css";?>" rel="stylesheet" type="text/css" />
<script language="javascript">
var catdata = <?php if($jsoncats){?><?php echo isset($jsoncats)?$jsoncats:"";?><?php }else{?>new Array()<?php }?>;
var detail_url = '<?php echo IUrl::creatUrl("/site/manual_discount_detail/id/@id@");?>';
var pagenum = 1;
</script>
<style>
.mui-scroll-wrapper {top:47px;}
</style>
<div class="mui-content">
...
<script type="text/javascript" src="<?php echo $this->getWebViewPath()."javascript/manual_discount.js";?>"></script>
