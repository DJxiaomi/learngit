...
<div class="mui-content">
    ...
    <div class="pro-tab">
      ...
      <a href="javascript:;" class="attr1" id="attrtext1">性别</a>
    ...
    <script type="text/javascript">
        ...
        mui.ready(function(){
            ...
            var attrdata = "[{value: '', text: '性别'}";
            attrdata += ",{value: 1, text: '男'}";
            attrdata += ",{value: 2, text: '女'}";
            attrdata += ']';
        ...
        function pullupRefresh() {
            setTimeout(function() {
                ...
                mui.get(SITE_URL + 'site/get_user_tutor_list_ajax', params, function(json){
                    if(json.num < 10){
                    ...
                    for (var i = 0; i < json.num; i++) {
                        ...
                        li.innerHTML = '<a href="' + json[i].link + '"><img class="mui-media-object mui-pull-left" src="/' + json[i].head_ico  + '">'+
                                            '<div class="mui-media-body">' + json[i].true_name +
                                                '<p class="mui-ellipsis">' + json[i].grade +
                                                '</p>' +
                                                '<div class="goodsprice" style="color:#dd137b;">学费：￥' + json[i].price + '</div>' +
                                            '</div>' +
                                          '</a>';
