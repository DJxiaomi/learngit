...
<article class="module width_full">
	<header>
		...
		<ul class="tabs">
			<li><input type="button" class="alt_btn" onclick="window.location.href='<?php echo IUrl::creatUrl("/seller/pro_rule_edit");?>';" value="添加活动" /></li>
	...
	<form method='post' action='<?php echo IUrl::creatUrl("/seller/pro_rule_del");?>'>
		<table class="tablesorter" cellspacing="0">
			...
			<tbody>
				<?php $query = new IQuery("promotion");$query->where = "seller_id = $seller_id and type = 0";$items = $query->find(); foreach($items as $key => $item){?>
				<tr>
					...
					<td>
						<a href='<?php echo IUrl::creatUrl("/seller/pro_rule_edit/id/".$item['id']."");?>'>
							<img class="operator" src="<?php echo $this->getWebSkinPath()."images/main/icn_edit.png";?>" alt="修改" title="修改" />
						</a>

						<a href='javascript:void(0)' onclick="delModel({link:'<?php echo IUrl::creatUrl("/seller/pro_rule_del/id/".$item['id']."");?>'});">
							<img class="operator" src="<?php echo $this->getWebSkinPath()."images/main/icn_del.png";?>" alt="删除" title="删除" />
						</a>
					</td>
				</tr>
				<?php }?>
