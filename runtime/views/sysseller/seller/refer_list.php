		...
		<table class="tablesorter" cellspacing="0">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="<?php echo IUrl::creatUrl("/seller/refer_edit/id/".$item['id']."");?>"><img src="<?php echo $this->getWebSkinPath()."images/main/icn_audio.png";?>" title="回复咨询" /></a>
						<a href="javascript:delModel({link:'<?php echo IUrl::creatUrl("/seller/refer_del/id/".$item['id']."");?>'})"><img src="<?php echo $this->getWebSkinPath()."images/main/icn_del.png";?>" title="删除" /></a>
					</td>
				</tr>
				<?php }?>
			</tbody>
