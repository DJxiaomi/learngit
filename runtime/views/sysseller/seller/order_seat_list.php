...
<article class="module width_full">
	...
	<header>
		...
		<h3 class="tabs_involved">购票订单列表</h3>
		...
		<ul class="tabs">
			...
			<li><input type="button" class="alt_btn tab_current" onclick="javascript:location.href='/seller/order_seat_list'" value="购票订单" /></li>
	...
	<table class="tablesorter" cellspacing="0">
		...
		<tbody>
			...
			<?php $orderObject = new IQuery("order as o");$orderObject->fields = "o.*";$orderObject->page = "$page";$orderObject->where = "o.seller_id = $seller_id and o.pay_status = 1 and o.if_del = 0 and o.statement = 5 and o.status not in(3,4) $where";$orderObject->order = "o.id desc";$items = $orderObject->find(); foreach($items as $key => $item){?>
